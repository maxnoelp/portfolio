...
<template>
  <section id="skills" class="skills section">
    ...
    <div class="container">
      <div class="section-subtitle mb-3" data-aos="fade-up">
        <h3>Frontend</h3>
      </div>
    <div class="row ">
      <!--Html-->
      <div class="col-xl-6 col-lg-6">
            <div class="card l-bg-cherry">
                <div class="card-statistic-3 p-4">
                    <div class="card-icon card-icon-large"><img src="../images/html-icon.png" alt=""></div>
                    <div class="row align-items-center mb-2 d-flex">
                        ...
                        <div class="col-4 text-right">
                            <span>90% <i class="bi bi-arrow-up"></i></span>
                        </div>
                    </div>
                    <div class="progress mt-1 " data-height="8" style="height: 8px;">
                        <div class="progress-bar l-bg-green" role="progressbar" data-width="90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-6 col-lg-6">
            <div class="card l-bg-purple-dark">
                <div class="card-statistic-3 p-4">
                    <div class="card-icon card-icon-large"><img src="../images/icon-bs.png" alt=""></div>
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0 text-white">
                                Bootstrap
                        ...
                        <div class="col-4 text-right">
                            <span>100% <i class="bi bi-arrow-up"></i></span>
                        </div>
                    </div>
                    <div class="progress mt-1 " data-height="8" style="height: 8px;">
                        <div class="progress-bar l-bg-green" role="progressbar" data-width="100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-6 col-lg-6">
            <div class="card l-bg-yellow-dark">
                <div class="card-statistic-3 p-4">
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        ...
                        <div class="col-4 text-right">
                            <span>85% <i class="bi bi-arrow-up"></i></span>
                        </div>
                    </div>
                    <div class="progress mt-1 " data-height="8" style="height: 8px;">
         ...
         <!--CSS-->
         <div class="col-xl-6 col-lg-6">
            <div class="card l-bg-css-dark">
                <div class="card-statistic-3 p-4">
                    <div class="card-icon card-icon-large"><img src="../images/css.png" alt=""></div>
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0 text-white">
                                CSS
            ...
            <div class="card l-bg-dark">
                <div class="card-statistic-3 p-4">
                    ...
                    <div class="row align-items-center mb-2 d-flex">
                        ...
                        <div class="col-4 text-right">
                            <span>95% <i class="bi bi-arrow-up"></i></span>
                        </div>
                    </div>
                    <div class="progress mt-1 " data-height="8" style="height: 8px;">
                        <div class="progress-bar l-bg-green" role="progressbar" data-width="95%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100" style="width: 95%;"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row ">
        ...
        <div class="col-xl-6 col-lg-6">
            <div class="card l-bg-dark">
                <div class="card-statistic-3 p-4">
                    <div class="card-icon card-icon-large"><img src="../images/github.png" alt=""></div>
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0 text-white">
                                Github
                    ...
                    <div class="progress mt-1 " data-height="8" style="height: 8px;">
                        <div class="progress-bar l-bg-green" role="progressbar" data-width="95%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"></div>
                    </div>
                </div>
            </div>
        </div>
...
.l-bg-purple-dark {
  background: linear-gradient(to right, rgb(36, 14, 82), rgb(112, 44, 249)) !important;
    color: #fff;
}
...
.l-bg-yellow-dark {
    background: linear-gradient(to right, #a79519, #f7df1e) !important;
    color: #fff;
}
...
.l-bg-css-dark {
    background: linear-gradient(to right, #122368, #2965f1) !important;
    color: #fff;
}
